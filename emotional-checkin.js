...
function getEmotionWords(emotion) {
    const emotionWordSets = {
        ...
        disappointed: ["실망스러운", "좌절한", "낙담한", "허탈한", "아쉬운", "안타까운", "섭섭한", "맥빠진", "풀죽은", "서운한"],
        tired: ["피곤한", "지친", "힘든", "녹초가된", "기운없는", "나른한", "축축늘어진", "무기력한", "졸린", "고단한"],
        surprised: ["놀란", "당황한", "어리둥절한", "깜짝놀란", "황당한", "의아한", "어안이벙벙한", "충격받은", "멍한", "얼떨떨한"]
    };
